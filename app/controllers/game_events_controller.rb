class GameEventsController < ApplicationController
  ...
  private
    ...
    def game_event_params
      params.require(:game_event).permit(:event, :option_1_message, :option_1_fn_body, :option_1_fn_return_message, :option_1_fn_end, :option_2_message, :option_2_fn_body, :option_2_fn_return_message, :option_2_fn_end)
    end
end
